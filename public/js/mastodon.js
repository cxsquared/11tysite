...
const MastodonBar = {
  config: {
    instanceName: "mastodon.gamedev.place",
    userName: "cxsquared",
    profileImg: "",
    itemsToDisplay: 1,
  },
  ...
  displayItems: function (data, dom) {
    const items = Array.from(data.querySelectorAll("item")).slice(
      0,
      MastodonBar.config.itemsToDisplay
    );
    var html = "";
